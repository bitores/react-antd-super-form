...
var Form = memo(function (props, ref) {
...
var Dialog = forwardRef(function (props, ref) {
  ...
  return React.createElement(
    ...
    React.createElement(Form, _extends({ _bindForm: function _bindForm(form) {
...
// 此 Modal 仅对于 form 来讲
var Dialog$$1 = forwardRef(function (props, ref) {
  // 不接收动态属性变化
  var _useState = useState(props.visible || false),
      _useState2 = slicedToArray(_useState, 2),
      isVisible = _useState2[0],
  ...
  return React.createElement(
    ...
    React.createElement(SuperTable, {
      ref: formRef,
      search: formData,
      table: table,
      formStyle: formStyle,
  ...
  return function (_React$PureComponent) {
    ...
    createClass(_class, [{
      ...
      value: function render() {
        ...
        return React.createElement(Component, _extends({ ref: this.hoc }, props));
      }
    }]);
    return _class;
  }(React.PureComponent);
...
var SuperForm = function SuperForm(props, ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Form, _extends({}, search, { autoSearchEvent: autoSearchEvent, _bindForm: _bindForm }))
    ),
    extra,
    React.createElement(
      'div',
      { className: styles.table, style: tableStyle },
      type === 'table' ? React.createElement(Table, _extends({ ref: list }, table, pr)) : React.createElement(List, _extends({ ref: list }, table, pr))
    )
  );
};

var SuperTable = withSearch(forwardRef(SuperForm));

export default SuperTable;
export { Form, Table, List, Dialog as Modal, Dialog$$1 as ModalTable };

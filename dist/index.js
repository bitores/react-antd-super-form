...
var _Space = _interopDefault(require('antd/es/space'));
...
var Form = React.memo(function (props, ref) {
  ...
  var renderElement = function renderElement(bindSearchEvent) {
    ...
    return formData.map(function (item, _) {
      ...
      if (visible !== false) {
        if (cType === 'br') {
          ret = React__default.createElement('p', { key: key, style: {
              display: 'block',
              width: '100%',
              height: 0,
              margin: 0,
          ...
          var _curCom2 = React__default.createElement(
            _Row,
          ...
          ret = unbind === true ? _curCom2 : React__default.createElement(
            _Form.Item,
            formItemProps,
            _curCom2
          );
          ...
          ret = unbind === true ? _curCom3 : React__default.createElement(
            _Form.Item,
          ...
          ret = unbind ? _curCom4 : React__default.createElement(
            _Form.Item,
            _extends({ name: key }, formItemProps),
            _curCom4
          );
